...
const styles = StyleSheet.create({
  ...
  thumbnail: { flexGrow: 1, flexBasis: 300, maxWidth: 520, aspectRatio: 16 / 9, borderRadius: radii.large, backgroundColor: "#CBD2DE" },
  heroCopy: { flex: 1, flexBasis: 280, gap: 8 },
  ...
  settingCard: { flex: 1, flexBasis: 290, minWidth: 270, borderWidth: 2, borderRadius: radii.large, padding: 17, gap: 10 },
