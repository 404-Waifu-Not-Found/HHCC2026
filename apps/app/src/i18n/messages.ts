...
export const messages = {
  en: {
    ...
    deleteQuestBody:
      "This permanently deletes this video quest, its quizzes, progress, notes, and review history.",
    deleteQuestFailed: "Could not delete this video quest.",
    library: "Library",
    ...
    profile: "Profile",
    profileSubtitle: "Your ClipQuest account and learning progress.",
    profileDetails: "Account details",
    quizActivity: "Quiz activity",
    quizActivitySingle: "1 quiz completed in the last year",
    quizActivitySummary: "quizzes completed in the last year",
  ...
  "zh-CN": {
    ...
    savedVideos: "你的视频任务",
    deleteQuest: "删除学习任务",
    deleteQuestBody: "这将永久删除该视频任务、测验、学习进度、笔记和复习记录。",
    deleteQuestFailed: "无法删除该视频任务。",
    library: "资料库",
    leaderboard: "排行榜",
    ...
    profile: "个人资料",
    profileSubtitle: "你的 ClipQuest 账户和学习进度。",
    profileDetails: "账户信息",
    quizActivity: "测验活动",
    quizActivitySingle: "过去一年完成了 1 次测验",
    quizActivitySummary: "次测验在过去一年完成",
    accountRole: "账户类型",
    emailStatus: "邮箱状态",
    learner: "学习者",
    administrator: "管理员",
