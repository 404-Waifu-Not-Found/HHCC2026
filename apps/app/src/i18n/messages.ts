...
export const messages = {
  en: {
    ...
    extensionUpdateBody:
      "This version cannot use concept-only evidence-grounded quiz recovery yet. Install ClipQuest Local AI 0.8.7 or newer to continue.",
  ...
  "zh-CN": {
    ...
    extensionUpdateBody:
      "当前版本尚不支持只测试知识点且基于证据的自动恢复测验生成。请安装 ClipQuest Local AI 0.8.7 或更高版本后继续。",
