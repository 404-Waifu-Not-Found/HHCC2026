...
export const messages = {
  en: {
    ...
    findingTranscript: "Finding the best transcript",
    preparingLessonText: "Preparing the lesson text",
    mappingConcepts: "Mapping key concepts",
    writingQuestions: "Writing your questions",
    shufflingChoices: "Shuffling answer choices",
  ...
  "zh-CN": {
    ...
    generate: "生成测验",
    gettingVideo: "正在获取视频",
    findingTranscript: "正在寻找最佳字幕",
    preparingLessonText: "正在整理课程文本",
    mappingConcepts: "正在梳理核心概念",
    writingQuestions: "正在编写测验题目",
    shufflingChoices: "正在随机排列选项",
