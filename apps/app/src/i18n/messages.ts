...
export const messages = {
  en: {
    ...
    extensionUpdateBody:
      "This version cannot use concept-first supervised quiz generation yet. Install ClipQuest Local AI 0.8.8 or newer to continue.",
  ...
  "zh-CN": {
    ...
    extensionUpdateBody:
      "当前版本尚不支持知识点优先且受监督的测验生成。请安装 ClipQuest Local AI 0.8.8 或更高版本后继续。",
