...
export const messages = {
  en: {
    ...
    generationAttempt: "DeepSeek attempt",
    retryingGeneration: "Retrying invalid AI output · attempt",
  ...
  "zh-CN": {
    ...
    generationAttempt: "DeepSeek 尝试",
    retryingGeneration: "正在重试无效的 AI 输出 · 第",
