...
export const messages = {
  en: {
    ...
    extensionUpdateBody:
      "This version cannot use automatic prompt-first quiz generation yet. Install ClipQuest Local AI 0.8.24 or newer to continue.",
  ...
  "zh-CN": {
    ...
    extensionUpdateBody:
      "当前版本尚不支持自动提示词优先测验生成。请安装 ClipQuest Local AI 0.8.24 或更高版本后继续。",
